...
export default function PrivacyPolicy() {
  ...
  return (
    ...
    >
      ...
      <p>
        Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href={`mailto:${email}`}>{email}</a>.
      </p>
      ...
      <p>
        <strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by PayPal, Visa and Master Card. You may find their privacy notice link(s) here: <a href="https://www.paypal.com/us/webapps/mpp/ua/privacy-full">PayPal</a>, <a href="https://usa.visa.com/legal/privacy-policy.html">Visa</a> and <a href="https://www.mastercard.us/en-us/vision/who-we-are/privacy.html">Mastercard</a>.
      </p>
      <p>
      ...
      <p>If you have questions or comments about your privacy rights, you may email us at <a href={`mailto:${email}`}>{email}</a>.</p>
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full text-sm border-collapse border border-slate-200">
          ...
          <tbody>
            <tr>
              <td className="border border-slate-200 p-2">A. Identifiers</td>
              <td className="border border-slate-200 p-2">Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">B. Personal information as defined in the California Customer Records statute</td>
              <td className="border border-slate-200 p-2">Name, contact information, education, employment, employment history, and financial information</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">C. Protected classification characteristics under state or federal law</td>
              <td className="border border-slate-200 p-2">Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">D. Commercial information</td>
              <td className="border border-slate-200 p-2">Transaction information, purchase history, financial details, and payment information</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">E. Biometric information</td>
              <td className="border border-slate-200 p-2">Fingerprints and voiceprints</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">F. Internet or other similar network activity</td>
              <td className="border border-slate-200 p-2">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">G. Geolocation data</td>
              <td className="border border-slate-200 p-2">Device location</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">H. Audio, electronic, sensory, or similar information</td>
              <td className="border border-slate-200 p-2">Images and audio, video or call recordings created in connection with our business activities</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">I. Professional or employment-related information</td>
              <td className="border border-slate-200 p-2">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">J. Education Information</td>
              <td className="border border-slate-200 p-2">Student records and directory information</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">K. Inferences drawn from collected personal information</td>
              <td className="border border-slate-200 p-2">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
            <tr>
              <td className="border border-slate-200 p-2">L. Sensitive personal Information</td>
              <td className="border border-slate-200 p-2">None</td>
              <td className="border border-slate-200 p-2 text-red-600 font-bold">NO</td>
            </tr>
          </tbody>
        </table>
      ...
      <p>
        Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please contact us at <a href={`mailto:${email}`}>{email}</a>.
      </p>
    </PolicyLayout>
  );
}
