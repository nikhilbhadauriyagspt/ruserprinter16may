...
export default function Checkout() {
  ...
  const finalizeOrder = async (paymentDetails: unknown = null) => {
    ...
    try {
      ...
      setOrderNumber(
        res.order_id || `ORD-${Math.floor(Math.random() * 1000000)}`
      );
          ...
          <div className="lg:col-span-7 xl:col-span-8">
            <div className="flex items-center mb-8">
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${
                    step === 2 ? "bg-primary text-white" : "bg-slate-200"
                  }`}
                >
                  2
                </div>
            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200 shadow-sm">
              {step === 1 ? (
                <div>
                  ...
                  <Form {...form}>
                    <form
                      onSubmit={form.handleSubmit(onSubmitShipping)}
                      className="space-y-6"
                    >
                      ...
                      <Button
                        type="submit"
                        size="lg"
                        className="w-full sm:w-auto mt-4 rounded-xl px-8"
                      >
                        Continue to Payment
                ...
                <div>
                  ...
                  >
                    <div
                      className={`flex items-center space-x-3 border-2 rounded-xl p-4 cursor-pointer transition-colors ${
                    ...
                    >
                      ...
                      <Label
                        htmlFor="paypal"
                        className="flex-1 cursor-pointer font-semibold text-base flex justify-between items-center"
                      >
                        PayPal
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-sm font-normal text-slate-500 mt-1">
                          Pay when you receive your equipment.
                        </p>
                      </Label>
                    </div>
                  </RadioGroup>
